...
public class ResponseDTO {
    ...
    @XmlElementRef(name = "statusCode", namespace = "http://resp.serviceDTO.service.imp.sixdee.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> statusCode;
    @XmlElementRef(name = "statusDescription", namespace = "http://resp.serviceDTO.service.imp.sixdee.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> statusDescription;
    @XmlElementRef(name = "timestamp", namespace = "http://resp.serviceDTO.service.imp.sixdee.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> timestamp;
    @XmlElementRef(name = "transcationId", namespace = "http://resp.serviceDTO.service.imp.sixdee.com/xsd", type = JAXBElement.class, required = false)
