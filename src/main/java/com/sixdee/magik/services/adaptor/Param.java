...
public class Param {
	...
	public String toString() {
		return "Param [name=" + name + ", value=" + value + ", count=" + count + ", samplingName=" + samplingName
				+ ", nodeName=" + nodeName + ", endNode=" + endNode + ", lineNumber=" + lineNumber + ", MultiParam="
				+ MultiParam + ", multiParams=" + multiParams + ", multiDetails=" + multiDetails + ", multiValue="
				+ multiValue + "]";
	}
