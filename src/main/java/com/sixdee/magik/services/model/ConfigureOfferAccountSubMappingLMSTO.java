...
@Entity
@Table(name = "LMS_CNFG_OFFER_SUB_MAPPING")
public class ConfigureOfferAccountSubMappingLMSTO {
	
	
	@Id
	//@GeneratedValue(strategy = GenerationType.IDENTITY)
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "ConfigureOfferAccountSubMappingLMSTO")
	@TableGenerator(name = "ConfigureOfferAccountSubMappingLMSTO", allocationSize = 1)
	@Column(name = "ID")
	private int autoId;
