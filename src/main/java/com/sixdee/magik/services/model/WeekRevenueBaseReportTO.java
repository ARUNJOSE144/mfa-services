...
@Entity
@Table(name = "RPT_WEEKON_REVENUE_BASE")
public class WeekRevenueBaseReportTO {
	
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "WeekRevenueBaseReportTO")
	@TableGenerator(name = "WeekRevenueBaseReportTO", allocationSize = 1)
	@Column(name = "ID")
	private int autoId;
	
	@Column(name = "IncrementalRevenue")
	private String incrementalrevenue;
	...
	public String getIncrementalrevenue() {
		return incrementalrevenue;
	}

	public void setIncrementalrevenue(String incrementalrevenue) {
