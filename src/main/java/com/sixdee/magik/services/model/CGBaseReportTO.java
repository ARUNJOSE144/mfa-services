...
@Entity
@Table(name = "RPT_CG_BASE")
public class CGBaseReportTO {
	
		@Id
		@GeneratedValue(strategy = GenerationType.TABLE, generator = "CGBaseReportTO")
		@TableGenerator(name = "CGBaseReportTO", allocationSize = 1)
		@Column(name = "ID")
		private int autoId;
		
		@Column(name = "CG_BASE")
		private String cg_base;
		...
		public void setTg_base(String cg_base) {
			this.cg_base = cg_base;
		}
		...
		public String getCg_base() {
			return cg_base;
		}

		public void setCg_base(String cg_base) {
			this.cg_base = cg_base;
		}
