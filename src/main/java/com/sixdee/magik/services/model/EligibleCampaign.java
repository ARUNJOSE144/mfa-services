...
public class EligibleCampaign {
	...
	private Map<Integer, CustomerCareDTO> activeCamp;
	
	
	public Map<Integer, CustomerCareDTO> getActiveCamp() {
		return activeCamp;
	}

	public void setActiveCamp(Map<Integer, CustomerCareDTO> activeCamp) {
