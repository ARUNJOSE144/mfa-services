...
@Entity
@Table(name = "LMS_CNFG_OFFER_LOC_MAPPING")
public class ConfigureOfferLocMappingLMSTO {

	
	@Id
	//@GeneratedValue(strategy = GenerationType.IDENTITY)
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "ConfigureOfferLocMappingLMSTO")
	@TableGenerator(name = "ConfigureOfferLocMappingLMSTO", allocationSize = 1)
	@Column(name = "ID")
	private int autoId;
